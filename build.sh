...
filename="./dist/GEMDRIVE.IMG"

# Copy the GEMDRIVE.BIN file to a ROM size file for testing
ST_WORKING_FOLDER=$working_folder stcmd cp ./dist/GEMDRIVE.BIN $filename
