...
first:
	dc.l $0
	dc.l $08000000 + gemdrive_emulator		; After GEMDOS init. Before booting from disks.
	dc.l 0
	dc.w GEMDOS_TIME 				;time
	dc.w GEMDOS_DATE 				;date
	dc.l gemdrive_emulator_end - gemdrive_emulator
	dc.b "EMUL",0
	even
